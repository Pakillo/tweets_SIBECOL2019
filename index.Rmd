...
```{r cloud_words_mob}
wordcloud(tweets, "words", min_count = 5, min_size = 1, max_words = 30)
```
...
wordcloud(tweets, "hashtags", min_count = 2, min_size = 1, max_words = 30)
```
...
wordcloud(tweets, "mentions", min_count = 2, min_size = 1, max_words = 30)
```
